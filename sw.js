const CACHE = "safelight-shell-v2026-09-03-72";
const CORE = [
  "./",
  "./index.html",
  ...
  "./css/slice-selection.css",
  "./css/watermark-tools.css",
  ...
  "./css/batch-tools.css",
  "./css/ui-motion.css",
  "./css/preview-zoom.css",
  "./css/export-profiles.css",
  ...
  "./js/slice-selection.js",
  "./js/watermark-renderer.js",
  "./js/editor-polish.js",
  "./js/apply-tools.js",
